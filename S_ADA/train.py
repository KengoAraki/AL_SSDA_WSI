...
def train_net(
    ...
    n_train = min(len(l_src_train_loader), len(unl_trg_train_loader))
    ...
    for epoch in range(epochs):
        ...
        with tqdm(
            ...
            # 短いdataloaderに合わせる
            for l_src_batch, unl_trg_batch in zip(
                l_src_train_loader, unl_trg_train_loader
            ):
                ...
                D_trg_imgs = unl_trg_imgs.to(device=device, dtype=torch.float32)
                D_src_labels = \
